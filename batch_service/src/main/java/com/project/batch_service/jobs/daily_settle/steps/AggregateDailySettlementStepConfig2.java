...
public class AggregateDailySettlementStepConfig2 {
...
//        reader.setFetchSize(CHUNK_SIZE);
    ...
    @Bean
    public ItemProcessor<SettlementAggregationResult, DailySettlement> aggregateDailySettlementProcessor2() {
        return result -> {
    ...
    @Bean
    public JpaItemWriter<DailySettlement> aggregateDailySettlementWriter2() {
    ...
    @Getter
    @AllArgsConstructor
    public static class SettlementAggregate {
